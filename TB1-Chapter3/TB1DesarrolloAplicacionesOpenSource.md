...
Logro del curso: Capacidad de comunicarse efectivamente con un rango de audiencias. En el siguiente cuadro se describen las acciones realizadas y enunciados de conclusiones por parte del grupo 5, que permiten sustentar el haber logrado y alzandado el ABET - EAC - Student Outcome 3. 

|Criterio específico |Acciones realizadas |Conclusiones |
| :- | :- | :- |
|3\.c1. Comunica oralmente con efectividad a diferentes rangos de audiencia.|<p>**JOSE MANUEL PARIONA LUCAS:** </p><p>**TB1**: </p><p>Lo que realice fue 2.4. Ubiquitous Language. Capítulo III: Requirements Specification 3.1. To-Be Scenario Mapping. 3.2. User Stories. 3.3. Impact Mapping. Product Backlog. Despliegue de la primera versión del Landing Page. Capítulo IV Y  V</p><p></p><p>**Marllely Anahi Arias Segil**</p><p>**TB1:**</p><p>Durante el proceso de entrevistas, pude comunicarme de manera efectiva de forma oral con los participantes, adaptando mi estilo de comunicación según el grupo y asegurándome de que comprendieran las preguntas de manera clara, lo cual permitió obtener respuestas detalladas.</p><p></p><p>**Jesús Fernando Paucar Zenteno**</p><p>**TB1:**</p><p>Durante la elaboración del Capítulo IV sobre la arquitectura del software, me encargué de presentar oralmente los diagramas de contexto, contenedores y componentes a mi grupo y al docente. Expliqué cada elemento técnico utilizando un lenguaje comprensible para audiencias tanto técnicas como no técnicas, adaptando mi vocabulario para asegurar que todos comprendieran la lógica detrás del diseño arquitectónico propuesto.</p><p></p><p>**Stephano Renan Valdivia Quispe**</p><p>**TB1:** </p><p>Durante la elaboración de la TB1 realice lo siguiente:** 1.2.2.4. Lean UX Canvas. 1.3. Segmentos objetivo. Capítulo II: Requirements Elicitation & Analysis 2.1. Competidores. 2.1.1. Análisis competitivo. 2.1.2. Estrategias y tácticas frente a competidores, capítulo 4 y 5. </p><p>**Alessandro Netto Zevallos Linares**</p><p>**TB1:** </p><p>Durante la elaboración de la TB1 realice lo siguiente:** </p><p>2\.2. Entrevistas. 2.2.1. Diseño de entrevistas. 2.2.2. Registro de entrevistas. 2.2.3. Análisis de entrevistas. 2.3. Needfinding. 2.3.1. User Personas. 2.3.2. User Task Matrix. 2.3.3. User Journey Mapping. 2.3.4. Empathy Mapping. 2.3.5. As-is Scenario Mapping. Capítulo 4 y 5 </p><p></p>|TB1: Las responsabilidades fueron distribuidas individualmente, permitiendo que cada miembro se enfocara en un aspecto particular del proyecto. Tras la asignación, todos completaron sus respectivas tareas con éxito. Al finalizar, cada integrante pudo comunicar sus ideas de manera efectiva en las discusiones verbales.|
|3\.c2. Comunica por escrito con efectividad a diferentes rangos de audiencia|<p>**JOSE MANUEL PARIONA LUCAS:** </p><p>**TB1:** Lo que realice fue 2.4. Ubiquitous Language. Capítulo III: Requirements Specification 3.1. To-Be Scenario Mapping. 3.2. User Stories. 3.3. Impact Mapping. Product Backlog. Despliegue de la primera versión del Landing Page. Capítulo IV Y  V</p><p></p><p>**Marllely Anahi Arias Segil**</p><p>**TB1:**</p><p>Se elaboró un análisis basado en las entrevistas realizadas, lo cual permitió entender mejor las necesidades de nuestros usuarios y cómo mejorar su experiencia. Este análisis fue clave para identificar patrones comunes y características importantes que nos ayudaron a definir las soluciones más adecuadas para atender sus requerimientos.</p><p></p><p></p><p>**Jesús Fernando Paucar Zenteno**</p><p>**TB1:**</p><p>Al desarrollar el Capítulo I del proyecto, redacté con claridad y estructura el perfil de la startup, la propuesta de solución y los segmentos objetivos, enfocándome en una comunicación efectiva que pudiera ser entendida tanto por profesionales técnicos como por posibles inversionistas o usuarios finales. Utilicé un lenguaje accesible pero preciso, destacando el valor de la solución en términos funcionales y de mercado.</p><p></p><p>**Stephano Renan Valdivia Quispe**</p><p>**TB1:** </p><p>Durante la elaboración de la TB1 realice lo siguiente:** 1.2.2.4. Lean UX Canvas. 1.3. Segmentos objetivo. Capítulo II: Requirements Elicitation & Analysis 2.1. Competidores. 2.1.1. Análisis competitivo. 2.1.2. Estrategias y tácticas frente a competidores, capítulo 4 y 5. </p><p>**Alessandro Netto Zevallos Linares**</p><p>**TB1:** </p><p>Durante la elaboración de la TB1 realice lo siguiente:** </p><p>2\.2. Entrevistas. 2.2.1. Diseño de entrevistas. 2.2.2. Registro de entrevistas. 2.2.3. Análisis de entrevistas. 2.3. Needfinding. 2.3.1. User Personas. 2.3.2. User Task Matrix. 2.3.3. User Journey Mapping. 2.3.4. Empathy Mapping. 2.3.5. As-is Scenario Mapping. Capítulo 4 y 5 </p><p></p>|TB1: En este sprint, cada miembro del equipo se centró en desarrollar los elementos asignados para esta entrega. Posteriormente, todos comunicaron formalmente y por escrito sus aportes, garantizando una presentación coherente y efectiva de nuestros avances.|
...
Es un nombre sencillo, memorable y alineado con el lenguaje técnico del público objetivo, que también transmite la idea de orientación, descubrimiento y comunidad.
...
Red social profesional orientada al networking, visibilidad de perfiles y búsqueda de empleo. Es ampliamente usada en el sector tecnológico para posicionamiento personal y empresarial.
...
- ¿Actualmente trabajas en una empresa del sector tecnológico? ¿En qué rol?
...
|||Como visitante, deseo acceder a una landing page clara y atractiva que explique el valor y funcionamiento de la plataforma, para comprender sus beneficios y registrarse de forma sencilla y rápida.|
| :- | :- | :- |

**User Stories** 

|**TITULO** |**DESCRIPCIÓN** |**CRITERIOS DE ACEPTACIÓN** |**RELACIONADO CON (EPIC  ID)** |
| :- | :- | :- | :- |
|**HU01- Registro de recomendación**|**Como usuario, deseo registrar una recomendación laboral detallada, para compartir mi experiencia con la comunidad.**|<p>**Scenario 1: Registro exitoso de recomendación<br>` `GIVEN un usuario logueado<br>` `WHEN completa correctamente el formulario de recomendación<br>` `THEN la recomendación es registrada y publicada en la plataforma<br>` `AND es visible en la sección "Trabajos Recomendados".**<br></p><p>**Scenario 2: Error al registrar por campos vacíos<br>` `GIVEN un usuario que deja campos obligatorios sin completar<br>` `WHEN intenta enviar la recomendación<br>` `THEN la plataforma muestra un mensaje de error indicando los campos vacíos<br>` `AND no permite guardar la recomendación hasta que todos los campos estén completos.**</p><p></p>|**EPIC-01**|
|**HU02- Edición de recomendación**|**Como usuario, deseo editar mis recomendaciones, para mantener la información actualizada.**|<p>**Scenario 3: Edición exitosa de recomendación**</p><p>**GIVEN un usuario con una recomendación publicada**</p><p>**WHEN accede a la opción "Editar" y modifica los campos**</p><p>**THEN los cambios son guardados correctamente**</p><p>**AND la recomendación actualizada es visible para otros usuarios.**</p>|**EPIC-01**|
|**HU03- Eliminación de recomendación**|**Como usuario, deseo eliminar recomendaciones, para retirar información desactualizada o errónea.**|<p>**Scenario 4: Eliminación confirmada de recomendación**</p><p>**GIVEN un usuario con una recomendación existente**</p><p>**WHEN selecciona "Eliminar" y confirma la acción**</p><p>**THEN la recomendación es eliminada de la plataforma**</p><p>**AND ya no es visible en los listados públicos.**</p>|**EPIC-01**|
|**HU04-Calificación de empresa**|**Como usuario, deseo calificar empresas con estrellas, para reflejar mi nivel de satisfacción.**|<p>**Scenario 5: Calificación exitosa de empresa**</p><p>**GIVEN un usuario que ha trabajado en una empresa**</p><p>**WHEN selecciona la cantidad de estrellas y confirma su calificación**</p><p>**THEN la evaluación se guarda correctamente**</p><p>**AND es visible en el perfil de la empresa.**</p>|**EPIC-02**|
|**HU05-Comentar experiencia en empresa**|**Como usuario, deseo dejar comentarios junto con mi calificación, para brindar contexto a otros profesionales.**|<p>**Scenario 6: Registro de comentario asociado a empresa**</p><p>**GIVEN un usuario en la sección de recomendación**</p><p>**WHEN escribe un comentario en el campo de observaciones**</p><p>**THEN el comentario se guarda junto a la calificación**</p><p>**AND es visible para todos los usuarios que consulten esa empresa.**</p>|**EPIC-02**|
|**HU06- Buscar trabajos recomendados**|**Como usuario, deseo buscar trabajos recomendados mediante filtros, para encontrar opciones que se ajusten a mis necesidades.**|<p>**Scenario 7: Búsqueda con filtros aplicada**</p><p>**GIVEN un usuario en la sección de "Ver Trabajos Recomendados"**</p><p>**WHEN selecciona filtros por carrera, ubicación o tecnologías**</p><p>**THEN los resultados se actualizan mostrando solo las recomendaciones que cumplen con los criterios**</p><p>**AND se permite modificar los filtros en cualquier momento.**</p>|**EPIC-03**|
|**HU07- Ordenar resultados de búsqueda**|**Como usuario, deseo ordenar los resultados según criterios como calificación o cercanía, para tomar decisiones más rápidas.**|<p>**Scenario 8: Ordenamiento de resultados**</p><p>**GIVEN una lista de trabajos recomendados**</p><p>**WHEN selecciona una opción de orden (por calificación, fecha o cercanía)**</p><p>**THEN los resultados se reorganizan automáticamente**</p><p>**AND se muestra el nuevo orden en pantalla.**</p>|**EPIC-03**|
|**HU08- Contactar autor de recomendación** |**Como usuario, deseo contactar al autor de una recomendación, para obtener detalles antes de postular.**|<p>**Scenario 9: Contacto exitoso entre usuarios**</p><p>**GIVEN un usuario que visualiza una recomendación**</p><p>**WHEN presiona el botón "Contactar" y envía un mensaje**</p><p>**THEN el autor de la recomendación recibe la notificación**</p><p>**AND el mensaje queda registrado en la bandeja de entrada.**</p>|**EPIC-04**|
|**HU09- Gestión de mensajes recibidos**|**Como usuario, deseo gestionar los mensajes que otros usuarios me envían, para responder o eliminarlos.**|<p>**Scenario 10: Gestión de mensajes**</p><p>**GIVEN que un usuario recibe un mensaje en la plataforma**</p><p>**WHEN accede a su bandeja de entrada**</p><p>**THEN puede visualizar el mensaje recibido**</p><p>**AND puede responderlo o eliminarlo si lo desea.**</p>|**EPIC-04**|
|**HU10-Interacción con Chatbot de Apoyo**|**Como usuario, deseo interactuar con un chatbot que me brinde apoyo emocional cuando sienta frustración en la búsqueda de trabajo.**|<p>**Scenario 11: Conversación de apoyo con el chatbot**</p><p>**GIVEN que un usuario abre la ventana del chatbot**</p><p>**WHEN ingresa un mensaje que expresa frustración o desmotivación**</p><p>**THEN el chatbot identifica el tono emocional**</p><p>**AND responde con un mensaje de apoyo o recursos recomendados.**</p>|**EPIC-05**|
|**HU11-Recibir frases motivadoras**|**Como usuario, deseo que el chatbot me envíe frases motivadoras durante una conversación para levantar mi ánimo.**|<p>**Scenario 12: Envío de frase motivadora por parte del chatbot**</p><p>**GIVEN que el usuario mantiene una conversación con el chatbot**</p><p>**WHEN el chatbot detecta sentimientos de ansiedad o preocupación**</p><p>**THEN responde con una frase motivacional positiva**</p><p>**AND sugiere posibles acciones o recursos adicionales.**</p>|**EPIC-05**|
|**HU12- Actualización de perfil de usuario**|**Como usuario, deseo actualizar mi información de contacto para asegurar que otros usuarios tengan acceso a mis datos actualizados.**|<p>**Scenario 13: Actualización exitosa de perfil**</p><p>**GIVEN que el usuario accede a su perfil personal**</p><p>**WHEN modifica sus datos y presiona guardar**</p><p>**THEN el sistema almacena los cambios correctamente**</p><p>**AND muestra un mensaje de confirmación.**</p>|**EPIC-06**|
|**HU13-Visualización de perfil**|**Como usuario, deseo poder visualizar mi información de contacto, para verificar que esté actualizada.**|<p>**Scenario 14: Visualización de datos de perfil<br>` `GIVEN que el usuario accede a la sección "Mi Perfil"<br>` `WHEN selecciona "Ver perfil"<br>` `THEN se muestran todos los datos registrados<br>` `AND se actualizan en tiempo real si son modificados.**<br></p><p></p>|**EPIC-06**|
|**HU14-Consultar ranking de empresas mejor valoradas**|**Como usuario, deseo consultar el listado de empresas con las mejores calificaciones, para identificar oportunidades laborales confiables.**|<p>**Scenario 15: Visualización de empresas mejor evaluadas**</p><p>**GIVEN que accedo a la sección "Ranking de Empresas"**</p><p>**WHEN selecciono "Mejor Valoradas"**</p><p>**THEN el sistema muestra una lista ordenada de mayor a menor puntuación**</p><p>**AND permite visitar el perfil detallado de cada empresa.**</p>|**EPIC-07**|
|**HU15 - Consultar ranking de empresas peor valoradas**|**Como usuario, deseo revisar las empresas con peor evaluación, para evitar ambientes laborales tóxicos.**|<p>**Scenario 16: Visualización de empresas peor evaluadas**</p><p>**GIVEN que accedo a la sección "Ranking de Empresas"**</p><p>**WHEN selecciono "Peor Valoradas"**</p><p>**THEN el sistema muestra la lista ordenada de menor a mayor puntuación**</p><p>**AND ofrece enlaces para ver opiniones detalladas.**</p>|**EPIC-07**|
|**HU16-Visualización de empresas en el mapa**|**Como usuario, deseo ver empresas recomendadas cerca de mi ubicación usando mapas, para encontrar oportunidades accesibles.**|<p>**Scenario 17: Visualización geolocalizada de empresas**</p><p>**GIVEN que el usuario otorga permiso de acceso a su ubicación**</p><p>**WHEN abre la sección de "Empresas Cercanas"**</p><p>**THEN el sistema muestra un mapa con las empresas recomendadas**</p><p>**AND permite acceder al perfil de cada empresa desde el mapa.**</p>|**EPIC-08**|
|**HU17-Recepción de notificaciones automáticas**|**Como usuario, deseo recibir notificaciones automáticas cuando otro usuario me envía un mensaje.**|<p>**Scenario 18: Envío de notificación por nuevo mensaje**</p><p>**GIVEN que un usuario recibe un mensaje privado**</p><p>**WHEN el mensaje es enviado**</p><p>**THEN el sistema envía una notificación automática al correo del receptor**</p><p>**AND almacena una copia en la bandeja de entrada interna.**</p>|**EPIC-08**|
|**HU18-Cambio de idioma en la plataforma**|**Como usuario, deseo cambiar el idioma de la plataforma para usarla en inglés o español, según mi preferencia.**|<p>**Scenario 19: Cambio exitoso de idioma**</p><p>**GIVEN que el usuario accede a la configuración de idioma**</p><p>**WHEN selecciona un idioma diferente**</p><p>**THEN toda la interfaz se actualiza con el nuevo idioma**</p><p>**AND los cambios se aplican en tiempo real.**</p>|**EPIC-09**|
|**HU19-Accesibilidad para usuarios con discapacidad visual**|**Como usuario con discapacidad visual, deseo que la plataforma sea compatible con lectores de pantalla para navegar sin problemas.**|<p>**Scenario 20: Soporte de lector de pantalla**</p><p>**GIVEN que un usuario accede a la plataforma con un lector de pantalla**</p><p>**WHEN navega por las secciones principales**</p><p>**THEN cada elemento es leído correctamente**</p><p>**AND los botones y enlaces son accesibles mediante teclado.**</p>|**EPIC-09**|
|**HU20-Protección de datos personales**|**Como usuario, deseo que mis datos personales estén protegidos mediante cifrado, para garantizar su seguridad.**|<p>**Scenario 21: Protección de datos con cifrado**</p><p>**GIVEN que un usuario envía datos personales en un formulario**</p><p>**WHEN los datos son procesados**</p><p>**THEN el sistema aplica cifrado antes de almacenarlos**</p><p>**AND garantiza que la información no es accesible para terceros.**</p>|**EPIC-10**|
|**HU21-Acceso seguro a la plataforma**|**Como usuario, deseo que la autenticación cuente con medidas de seguridad, para evitar accesos no autorizados.**|<p>**Scenario 22: Inicio de sesión seguro<br>` `GIVEN que un usuario accede a la pantalla de inicio de sesión<br>` `WHEN ingresa sus credenciales<br>` `THEN el sistema verifica autenticación segura mediante HTTPS<br>` `AND permite o deniega el acceso según la validez de las credenciales.**<br></p><p></p>|**EPIC-10**|
|**HU22-Navegación informativa en la Landing Page**|**Como visitante, deseo recorrer la landing page para entender cómo funciona la plataforma antes de registrarme.**|<p>**Scenario 23: Recorrido de la landing page<br>` `GIVEN que un visitante accede a la landing page<br>` `WHEN navega haciendo scroll o selecciona menús<br>` `THEN puede conocer las secciones explicativas de la plataforma<br>` `AND encuentra el botón de registro fácilmente en la parte superior e inferior.**<br></p><p></p>|**EPIC-11**|
|**HU23-Redirección a formulario de registro**|**Como visitante, deseo ser redirigido fácilmente desde la landing page al formulario de registro para crear mi cuenta.**|<p>**Scenario 24: Acceso desde landing a registro**</p><p>**GIVEN que un visitante está en la landing page**</p><p>**WHEN hace clic en "Únete Ahora"**</p><p>**THEN el sistema lo redirige al formulario de registro**</p><p>**AND carga el formulario sin errores.**</p>|**EPIC-11**|
|**HU24- Registro de nuevo usuario**|**Como nuevo usuario, deseo registrarme en la plataforma para crear un perfil personal y comenzar a usar todas las funcionalidades.**|<p>**Scenario 25: Registro exitoso de usuario**</p><p>**GIVEN un nuevo usuario que desea registrarse**</p><p>**WHEN completa el formulario de registro con sus datos válidos**</p><p>**THEN la plataforma crea su cuenta correctamente**</p><p>**AND envía un correo de confirmación con los detalles de acceso.**</p><p>**Scenario 26: Error en el registro por campos incompletos**</p><p>**GIVEN que un usuario deja campos obligatorios vacíos**</p><p>**WHEN intenta enviar el formulario de registro**</p><p>**THEN la plataforma muestra un mensaje de error indicando los campos faltantes**</p><p>**AND no permite crear la cuenta hasta completar toda la información requerida.**</p>|**EPIC-06**|
|**HU25-Inicio de sesión seguro**|**Como usuario registrado, deseo iniciar sesión en la plataforma de manera segura, para acceder a mi perfil y usar las funcionalidades.**|<p>**Scenario 27: Inicio de sesión exitoso<br>` `GIVEN que el usuario tiene una cuenta registrada<br>` `WHEN ingresa su correo y contraseña correctamente<br>` `THEN la plataforma valida las credenciales<br>` `AND redirige al usuario a la página principal.**</p><p>**Scenario 28: Fallo en el inicio de sesión por datos incorrectos**</p><p>**GIVEN que el usuario ingresa un correo o contraseña inválidos**</p><p>**WHEN intenta iniciar sesión**</p><p>**THEN la plataforma muestra un mensaje de error**</p><p>**AND no permite el acceso hasta que se ingresen las credenciales correctas.**<br></p><p></p>|**EPIC-06**|
|**HU26-Recuperación de contraseña**|**Como usuario, deseo poder recuperar mi contraseña en caso de olvido, para poder acceder nuevamente a la plataforma.**|<p>**Scenario 29: Recuperación exitosa de contraseña**</p><p>**GIVEN que un usuario olvida su contraseña**</p><p>**WHEN solicita recuperación mediante la opción "Olvidé mi contraseña"**</p><p>**THEN la plataforma envía un enlace de restablecimiento al correo registrado**</p><p>**AND permite crear una nueva contraseña de acceso.**</p>|**EPIC-06**|
...
|**Meta (Goal)**|**Actores (Who)**|**Impactos (How)**|**Entregables (What)**|
| :-: | :-: | :-: | :-: |
|**Ayudar a profesionales tecnológicos en actividad a tomar mejores decisiones laborales a través de recomendaciones confiables.**|<p>**Joseph Rios — Profesional con experiencia en empresas tecnológicas.**</p><p>![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.024.png)</p>|**Compartir sus propias experiencias laborales en la plataforma.**|<p>**US-1: Registro de recomendación.**</p><p>**US-4: Calificación de empresa.**</p><p>**US-5: Comentar experiencia en empresa.**</p>|
|||**Consultar las recomendaciones de otros profesionales sobre empresas antes de postular.**|<p>**US-6: Buscar trabajos recomendados.**</p><p>**US-7: Ordenar resultados de búsqueda.**</p>|
|||**Contactar a colegas que publicaron recomendaciones para aclarar dudas.**|<p>**US-8: Contactar autor de recomendación.**</p><p>**US-9: Gestión de mensajes recibidos.**</p>|
|||**Ver rankings de mejores y peores empresas para identificar empleadores recomendados o a evitar.**|<p>**US-14: Ranking de mejores empresas.**</p><p>**US-15: Ranking de peores empresas.**</p>|
|||**Actualizar sus datos de perfil para mantener su información de contacto actualizada.**|<p>**US-12: Actualización de perfil.**</p><p>**US-13: Visualización de perfil.**</p>|
...
|**Meta (Goal)**|**Actores (Who)**|**Impactos (How)**|**Entregables (What)**|
| :-: | :-: | :-: | :-: |
|**Facilitar la búsqueda de empleo a estudiantes que están por egresar, brindándoles acceso a información confiable sobre empresas y empleadores.**|<p>**Antonio Herrera — Estudiante sin experiencia.**</p><p></p><p>![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.025.png)</p>|**Consultar recomendaciones para evitar empresas con malas prácticas y encontrar empleadores confiables.**|<p>**US-6: Buscar trabajos recomendados.**</p><p>**US-7: Ordenar resultados de búsqueda.**</p><p>**US-14: Ranking de mejores empresas.**</p><p>**US-15: Ranking de peores empresas.**</p>|
|||**Contactar a usuarios que han calificado empresas para resolver dudas antes de postular.**|<p>**US-8: Contactar autor de recomendación.**</p><p>**US-9: Gestión de mensajes recibidos.**</p>|
|||**Acceder al chatbot en momentos de frustración o ansiedad durante la búsqueda de empleo.**|<p>**US-10: Interacción con Chatbot.**</p><p>**US-11: Frases motivadoras.**</p>|
|||**Crear su cuenta y actualizar su perfil para empezar a usar la plataforma.**|<p>**US-24: Registro de nuevo usuario.**</p><p>**US-12: Actualización de perfil.**</p>|

**Maria Herrera — Egresada en Búsqueda de Empleo**
...
|**Meta (Goal)**|**Actores (Who)**|**Impactos (How)**|**Entregables (What)**|
| :-: | :-: | :-: | :-: |
|**Brindar herramientas a egresados para encontrar trabajos adecuados, evitando ambientes laborales tóxicos y accediendo a datos de empleadores confiables.**|<p>**Maria Herrera — Egresada en búsqueda de empleo.**</p><p></p><p>![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.026.png)</p>|**Consultar rankings, calificaciones y comentarios sobre empresas para tomar decisiones informadas.**|<p>**US-4: Calificación de empresa.**</p><p>**US-5: Comentar experiencia.**</p><p>**US-14: Ranking de mejores empresas.**</p><p>**US-15: Ranking de peores empresas.**</p>|
|||**Contactar autores de recomendaciones para validar la información antes de postular.**|<p>**US-8: Contactar autor de recomendación.**</p><p>**US-9: Gestión de mensajes recibidos.**</p>|
|||**Usar filtros y ordenar resultados para buscar opciones acordes a sus preferencias.**|<p>**US-6: Buscar trabajos recomendados.**</p><p>**US-7: Ordenar resultados de búsqueda.**</p>|
|||**Acceder al chatbot para soporte emocional durante la búsqueda.**|<p>**US-10: Interacción con Chatbot.**</p><p>**US-11: Frases motivadoras.**</p>|
|||**Crear su cuenta, iniciar sesión y gestionar sus datos de contacto.**|<p>**US-24: Registro de nuevo usuario.**</p><p>**US-25: Inicio de sesión seguro.**</p><p>**US-12: Actualización de perfil.**</p>|

**3.4.Product Backlog**

|**Orden**|**User Story/Technical Story ID**|**Título**|**Descripción**|**Story Points**|
| :-: | :-: | :-: | :-: | :-: |
|**1**|**US-24**|**Registro de nuevo usuario**|**Como nuevo usuario, deseo registrarme en la plataforma para crear un perfil personal.**|**8**|
|**2**|**US-25**|**Inicio de sesión seguro**|**Como usuario registrado, deseo iniciar sesión de manera segura en la plataforma.**|**8**|
|**3**|**US-1**|**Registro de recomendación**|**Como usuario, deseo registrar una recomendación laboral con detalles sobre la empresa.**|**8**|
|**4**|**US-4**|**Calificación de empresa**|**Como usuario, deseo asignar una calificación con estrellas a las empresas.**|**8**|
|**5**|**US-6**|**Buscar trabajos recomendados**|**Como usuario, deseo buscar trabajos recomendados mediante filtros personalizados.**|**5**|
|**6**|**US-2**|**Edición de recomendación**|**Como usuario, deseo editar mis recomendaciones para mantener la información actualizada.**|**5**|
|**7**|**US-3**|**Eliminación de recomendación**|**Como usuario, deseo eliminar recomendaciones obsoletas o incorrectas.**|**5**|
|**8**|**US-5**|**Comentar experiencia en empresa**|**Como usuario, deseo dejar comentarios junto a mi calificación para brindar contexto.**|**5**|
|**9**|**US-26**|**Recuperación de contraseña**|**Como usuario, deseo recuperar mi contraseña en caso de olvido para acceder a la plataforma.**|**5**|
|**10**|**US-7**|**Ordenar resultados de búsqueda**|**Como usuario, deseo ordenar las recomendaciones según criterios como calificación o cercanía.**|**5**|
|**11**|**US-8**|**Contactar autor de recomendación**|**Como usuario, deseo contactar al autor de una recomendación antes de postular.**|**5**|
|**12**|**US-9**|**Gestión de mensajes recibidos**|**Como usuario, deseo gestionar los mensajes recibidos de otros usuarios.**|**3**|
|**13**|**US-10**|**Interacción con Chatbot de Apoyo**|**Como usuario, deseo interactuar con un chatbot para recibir apoyo emocional.**|**3**|
|**14**|**US-11**|**Recibir frases motivadoras**|**Como usuario, deseo que el chatbot me envíe frases motivadoras en momentos difíciles.**|**3**|
|**15**|**US-12**|**Actualización de perfil de usuario**|**Como usuario, deseo actualizar mi información de contacto en la plataforma.**|**3**|
|**16**|**US-13**|**Visualización de perfil**|**Como usuario, deseo visualizar mi información de contacto para verificar que esté actualizada.**|**3**|
|**17**|**US-14**|**Consultar ranking de mejores empresas**|**Como usuario, deseo consultar las empresas mejor evaluadas por la comunidad.**|**3**|
|**18**|**US-15**|**Consultar ranking de peores empresas**|**Como usuario, deseo conocer las empresas peor valoradas y evitar ambientes tóxicos.**|**3**|
|**19**|**US-16**|**Visualización de empresas en el mapa**|**Como usuario, deseo ver empresas recomendadas cerca de mi ubicación usando mapas.**|**3**|
|**20**|**US-17**|**Recepción de notificaciones automáticas**|**Como usuario, deseo recibir notificaciones cuando otros usuarios me contacten.**|**3**|
|**21**|**US-18**|**Cambio de idioma en la plataforma**|**Como usuario, deseo cambiar el idioma de la plataforma entre español e inglés.**|**2**|
|**22**|**US-19**|**Accesibilidad con lector de pantalla**|**Como usuario con discapacidad, deseo que la plataforma sea compatible con lectores de pantalla.**|**2**|
|**23**|**US-20**|**Protección de datos personales**|**Como usuario, deseo que mis datos estén protegidos mediante cifrado.**|**2**|
|**24**|**US-21**|**Acceso seguro a la plataforma**|**Como usuario, deseo que la autenticación tenga medidas de seguridad sólidas.** |**2**|
|**25**|**US-22**|**Navegación informativa en la Landing Page**|**Como visitante, deseo recorrer la landing page para conocer la plataforma.**|**1**|
|**26**|**US-23**|**Redirección a formulario de registro**|**Como visitante, deseo ser redirigido desde la landing page al formulario de registro.**|**1**|
...
![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.029.png)
...
Se incorporarán animaciones suaves y transiciones sutiles al interactuar con botones, formularios y menús, con el objetivo de aportar dinamismo sin restar velocidad. Estos elementos harán que la interacción sea más natural y agradable.
...
Etiquetado Visual y Funcional: Los íconos que acompañan a cada etiqueta también están pensados para reforzar su significado. Por ejemplo, el símbolo de un mapa acompaña la sección Empresas Cercanas, mientras que un ícono de estrella señala la sección de Ranking de Empresas.
...
Con estos mecanismos, se asegura una experiencia fluida que permite a los usuarios encontrar rápidamente la información que necesitan para tomar decisiones laborales informadas.
...
Navegación por Tarjetas y Secciones: El diseño emplea bloques visuales o tarjetas interactivas que permiten explorar información de forma segmentada, como empresas destacadas, rankings, últimas reseñas o alertas recientes.

Enlaces Contextuales y Botones de Acción: A lo largo del contenido, se integran botones de acción como “Ver más”, “Contactar”, “Calificar empresa” que invitan a continuar la navegación de manera intuitiva y guiada.

Responsive Design: Todo el sistema de navegación está adaptado para funcionar de forma óptima tanto en computadoras de escritorio como en dispositivos móviles, asegurando accesibilidad desde cualquier entorno.

Estos sistemas de navegación fortalecen la usabilidad general de la plataforma, facilitando el descubrimiento de funcionalidades y mejorando la retención de los usuarios.

**4.3. Landing Page UI Design.**

En esta sección se muestra la propuesta de interfaz de usuario (UI) para la Landing Page de TuChambaMasCercana.

**4.3.1 Landing Page Wireframe**

En TuChambaMásCercana, hemos diseñado una Landing Page pensada para guiar al usuario de forma clara y atractiva hacia el valor principal de nuestra plataforma: descubrir y compartir experiencias laborales reales en el sector tecnológico. A continuación, presentamos las secciones clave del wireframe y su funcionalidad:

🧭 Barra de Navegación

Ubicada en la parte superior de la página, esta barra permite un acceso rápido a las secciones más importantes. Incluye las siguientes opciones:

Inicio: Lleva al usuario a la sección principal con una presentación clara de la misión del proyecto y su propuesta de valor.

Beneficios: Describe cómo la plataforma ayuda a los usuarios a tomar mejores decisiones laborales mediante experiencias reales y filtradas.

Comunidad: Muestra testimonios breves de usuarios reales y promueve el sentido de colaboración entre profesionales.

Testimonios: Presenta experiencias en profundidad sobre cómo TuChambaMásCercana impactó positivamente en sus decisiones laborales.

Conócenos: Sección dedicada al equipo detrás del proyecto, destacando su compromiso con la transparencia laboral.

Videos: Muestra contenido audiovisual que resume el funcionamiento de la plataforma y su impacto en la comunidad tecnológica.

Soporte y Ayuda: Canal directo para resolver dudas o recibir orientación sobre el uso de la plataforma.

Iniciar sesión / Regístrate: Botones destacados que dirigen al usuario a las páginas de autenticación.

**Link del Figma: <https://www.figma.com/design/IS6Adu0QVoYFAYeRQ5i0jN/TuChambaMasCerca?node-id=0-1&t=0yHxjGogZs6efEXJ-1>** 

Esta sección presenta los wireframes del Landing Page de TuChambaMasCercana para Desktop Web Browser.

**Wireframe - Sección Hero**

![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.033.png)

**Wireframe - Sección Beneficios**

![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.034.png)

**Wireframe - Sección Comunidad**

![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.035.png)

**Wireframe - Sección Testimonio**

![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.036.png)

**Wireframe - Sección Conoce al Equipo**

![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.037.png)

**Wireframe - Sección Videos + Acerca de Nosotros**

![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.038.png)

**Wireframe - Sección Soporte y Ayuda + Footer**

![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.039.png)

**4.3.2 Landing Page Mock-up**

Esta sección presenta los Mock-up del Landing Page de TuChambaMasCercana para Desktop Web Browser.

**Mock-up - Sección Hero**

![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.040.png)

**Mock-up - Sección Beneficios**

![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.041.png)

**Mock-up - Sección Comunidad**

![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.042.png)

**Mock-up - Sección Testimonio**

![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.043.png)

**Mock-up - Sección Conoce al Equipo**

![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.044.png)

**Mock-up - Sección Videos + Acerca de Nosotros**

![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.045.png)

**Mock-up - Sección Soporte y Ayuda + Footer**

![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.046.png)

**4.4. Web Applications UX/UI Design** 

**4.4.1. Web Applications Wireframes.**

![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.047.png)

<https://www.figma.com/design/PBMT7m2WRVNmkRplKgbnZc/Open-Source-project?node-id=19-2&m=dev&t=Y3MN6QsAqHzml0f3-1>

**4.4.2. Web Applications Wireflow Diagrams.**

![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.048.png)
...
Link: <https://www.figma.com/design/PBMT7m2WRVNmkRplKgbnZc/Open-Source-project?node-id=19-2&m=dev&t=Y3MN6QsAqHzml0f3-1>

**4.5. Web Applications Prototyping.**

Los criterios que guiaron las decisiones de interacción están centrados en ofrecer una experiencia fluida, intuitiva y coherente. Se priorizó la accesibilidad, la facilidad de uso y la estética funcional, siguiendo los principios del diseño centrado en el usuario. Las decisiones aquí evidencian la aplicación de la arquitectura de información previamente desarrollada, en especial en lo que respecta al sistema de navegación (Navigation Systems), la estructura jerárquica del contenido (Organization Systems) y los sistemas de búsqueda integrados (Searching Systems).

Link del prototipo: <https://www.figma.com/proto/PBMT7m2WRVNmkRplKgbnZc/Open-Source-project?node-id=2026-30&t=Y3MN6QsAqHzml0f3-1>

**4.6. Domain-Driven Software Architecture.**

Este enfoque de diseño de software se centra en analizar y entender detalladamente el contexto específico en el que se utilizará la aplicación. Busca crear software que responda exactamente a los requerimientos y objetivos comerciales del entorno en el que se implementa.

**4.6.1. Software Architecture Context Diagram.**

![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.050.png)

**4.6.2. Software Architecture Container Diagrams.**

![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.051.png)

**4.6.3. Software Architecture Components Diagrams**

![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.052.png)

**4.7.  Software Object-Oriented Design**

En esta sección se verá la estructuración de nuestra start-up que será a lo largo de nuestro proyecto: 

**4.7.1. Class Diagrams**

![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.053.png)

**4.7.2. Class Dictionary**
### <a name="_sbx9vepz26zz"></a>**Dominio: Usuario**
#### <a name="_qub42ryxp7cs"></a>**Clase: Usuario**

|**Atributo**|**Tipo**|**Descripción**|
| :-: | :-: | :-: |
|**id**|**BIGINT (PK, IDENTITY)**|**Identificador único del usuario**|
|**correo**|**VARCHAR**|**Correo electrónico único del usuario**|
|**clave**|**VARCHAR**|**Contraseña encriptada**|
|**idiomaPreferido**|**STRING**|**Idioma de preferencia del usuario**|
|**esAnonimo**|**BOOLEAN, DEFAULT TRUE**|**Determina si el perfil es anónimo**|
|**habilitado**|**BOOLEAN, DEFAULT TRUE**|**Estado activo del usuario**|
|**fechaRegistro**|**DATE**|**Fecha de creación de cuenta**|
...
-----
#### <a name="_e02jfbibrvno"></a>**Clase: Perfil**

|**Atributo**|**Tipo**|**Descripción**|
| :-: | :-: | :-: |
|**id**|**BIGINT (PK)**|**ID del perfil**|
|**usuarioId**|**BIGINT (FK)**|**Relación uno a uno con Usuario**|
|**contactoVisible**|**BOOLEAN**|**Controla si el usuario quiere mostrar contacto**|
|**ultimaActualizacion**|**DATE**|**Fecha de última modificación del perfil**|

**Métodos:**

- **verPerfil(): void**

- **actualizarPerfil(contacto: STRING): void**

-----
#### <a name="_5r56ltgg09ad"></a>**Clase: Subscripcion**

|**Atributo**|**Tipo**|**Descripción**|
| :-: | :-: | :-: |
|**id**|**BIGINT (PK)**|**ID de suscripción**|
|**usuarioId**|**BIGINT (FK)**|**Usuario que tiene la suscripción**|
|**tipo**|**STRING**|**"Freemium" o "Premium"**|
|**fechaInicio**|**DATE**|**Inicio del plan**|
|**fechaFin**|**DATE**|**Fin del plan**|
|**estado**|**STRING**|**Estado: activo, expirado, cancelado**|
...
-----
### <a name="_98lpt5elg4sv"></a>**Dominio: Empresa y Recomendaciones**
#### <a name="_g5qutmc1pge9"></a>**Clase: Empresa**

|**Atributo**|**Tipo**|**Descripción**|
| :-: | :-: | :-: |
|**id**|**BIGINT (PK)**|**ID de la empresa**|
|**nombre**|**STRING**|**Nombre de la empresa**|
|**ubicacion**|**STRING**|**Dirección / distrito**|
|**tecnologias**|**STRING**|**Herramientas utilizadas**|
|**beneficios**|**STRING**|**Beneficios destacados**|
|**cultura**|**TEXT**|**Descripción del clima laboral**|
...
-----
#### <a name="_6ue8p07v23th"></a>**Clase: Recomendacion**

|**Atributo**|**Tipo**|**Descripción**|
| :-: | :-: | :-: |
|**id**|**BIGINT (PK)**|**ID de la recomendación**|
|**usuarioId**|**BIGINT (FK)**|**Usuario que publica**|
|**empresaId**|**BIGINT (FK)**|**Empresa evaluada**|
|**salario**|**DECIMAL**|**Sueldo reportado**|
|**herramientas**|**TEXT**|**Herramientas usadas**|
|**ambienteLaboral**|**TEXT**|**Condiciones de trabajo**|
|**procesoEntrevista**|**TEXT**|**Detalles del proceso**|
...
-----
#### <a name="_e63qcej8pxjm"></a>**Clase: Comentario**

|**Atributo**|**Tipo**|**Descripción**|
| :-: | :-: | :-: |
|**id**|**BIGINT (PK)**|**ID del comentario**|
|**usuarioId**|**BIGINT (FK)**|**Usuario que comenta**|
|**recomendacionId**|**BIGINT (FK)**|**Recomendación comentada**|
|**contenido**|**TEXT**|**Contenido textual**|
|**fecha**|**DATE**|**Fecha del comentario**|

-----
#### <a name="_zh5ccm7ari34"></a>**Clase: Calificacion**

|**Atributo**|**Tipo**|**Descripción**|
| :-: | :-: | :-: |
|**id**|**BIGINT (PK)**|**ID de calificación**|
|**usuarioId**|**BIGINT (FK)**|**Usuario que califica**|
|**empresaId**|**BIGINT (FK)**|**Empresa calificada**|
|**puntuacion**|**INT**|**De 1 a 5 estrellas**|
|**fecha**|**DATE**|**Fecha de evaluación**|

-----
### <a name="_uwwrswe7twnz"></a>**Dominio: Comunicación**
#### <a name="_t0svjw12zo9v"></a>**Clase: Mensaje**

|**Atributo**|**Tipo**|**Descripción**|
| :-: | :-: | :-: |
|**id**|**BIGINT (PK)**|**ID del mensaje**|
|**remitenteId**|**BIGINT (FK)**|**Usuario que envía**|
|**destinatarioId**|**BIGINT (FK)**|**Usuario que recibe**|
|**contenido**|**TEXT**|**Texto del mensaje**|
|**fechaEnvio**|**DATE**|**Fecha y hora**|
|**leido**|**BOOLEAN**|**Estado de lectura**|

-----
### <a name="_n3lvad9f1a0n"></a>**Dominio: Emocional**
#### <a name="_3cofmwxot4u7"></a>**Clase: Chatbot**

|**Atributo**|**Tipo**|**Descripción**|
| :-: | :-: | :-: |
|**id**|**BIGINT (PK)**|**ID del bot**|
|**nombre**|**STRING**|**Nombre del bot**|
|**frasesMotivadoras**|**TEXT[]**|**Lista de frases automáticas**|

**Método:**

- **enviarFrase(usuarioId: BIGINT): STRING**

-----
### <a name="_ykv80z2avyuy"></a> **Dominio: Seguridad**
#### <a name="_8e5c74du155k"></a>**Clase: Seguridad**

|**Atributo**|**Tipo**|**Descripción**|
| :-: | :-: | :-: |
|**id**|**BIGINT (PK)**|**ID del control**|
|**usuarioId**|**BIGINT (FK)**|**Usuario asegurado**|
|**tipoAutenticacion**|**STRING**|**Ej: "email", "2FA"**|
|**usoHTTPS**|**BOOLEAN**|**Canal seguro**|
|**datosCifrados**|**BOOLEAN**|**Encriptación**|
|**nivelAcceso**|**STRING**|**Ej: "básico", "admin"**|

-----
### <a name="_jncbuv1m87b0"></a>**Dominio: Búsqueda y Ranking**
#### <a name="_rha1lhv0u8zv"></a>**Clase: FiltroBusqueda**

|**Atributo**|**Tipo**|**Descripción**|
| :-: | :-: | :-: |
|**id**|**BIGINT (PK)**|**ID del filtro**|
|**usuarioId**|**BIGINT (FK)**|**Usuario que usa filtro**|
|**ubicacion**|**STRING**|**Ubicación geográfica**|
|**salarioMin**|**DECIMAL**|**Filtro mínimo de sueldo**|
|**tecnologia**|**STRING**|**Tecnología preferida**|
|**beneficio**|**STRING**|**Beneficio buscado**|
|**orden**|**STRING**|**Criterio de orden**|
|**esAvanzado**|**BOOLEAN**|**Requiere Premium**|

**Método:**

- **aplicarFiltros(): List<Recomendacion>**

-----
#### <a name="_3r9bduactitj"></a>**Clase: Ranking**

|**Atributo**|**Tipo**|**Descripción**|
| :-: | :-: | :-: |
|**id**|**BIGINT (PK)**|**ID del ranking**|
|**tipo**|**STRING**|**"Mejor" o "Peor"**|
|**criterios**|**STRING**|**Criterios usados**|
|**empresaId**|**BIGINT (FK)**|**Empresa listada**|

-----
### <a name="_a84t71v07ef7"></a>**Dominio: Landing Page**
#### <a name="_dbq6g3mxm5fp"></a>**Clase: LandingPage**

|**Atributo**|**Tipo**|**Descripción**|
| :-: | :-: | :-: |
|**id**|**BIGINT (PK)**|**ID de la página**|
|**titulo**|**STRING**|**Encabezado**|
|**descripcion**|**TEXT**|**Qué ofrece la plataforma**|
...
Veremos el diagrama de nuestra base de datos, posterior a esto habrá correcciones dependiendo a observaciones en nuestro proyecto.

**4.8.1 Database Diagram**

![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.054.png)


**Capítulo V: Product Implementation, Validation & Deployment.**

**5.1. Software Configuration Management.**
### <a name="_p3ynzic5ffd7"></a>**5.1.1 Software Development Environment Configuration**
Gestión del Proyecto

- GitHub (<https://github.com>)
  Se creó una organización con cuatro repositorios: Informe, Landing Page, Frontend y Backend. En GitHub se centraliza la gestión del código fuente, issues y colaboración entre los miembros del equipo.

Gestión de Requisitos

- Pivotal Tracker (<https://www.pivotaltracker.com>)
  Se utiliza para la gestión de historias de usuario y tareas. Aquí se organiza el *product backlog* y se hace seguimiento del avance del proyecto.

Diseño UX/UI del Producto

- UXPressia (<https://uxpressia.com>)
  Herramienta para desarrollar los perfiles de usuario (*User Persona*), mapas de empatía y *User Journey Mapping*.
- Figma (<https://www.figma.com/es-es>)
  Usado para la creación de *wireframes*, *mockups* y prototipos de la Landing Page y futura aplicación web.

Desarrollo de Software

- Git: Sistema de control de versiones distribuido.
- HTML5 y CSS3: Lenguajes usados para la estructura y estilo de la Landing Page.
- JavaScript: Lenguaje de programación que añade dinamismo e interactividad.
- VSCode: Editor de código fuente utilizado para el desarrollo.
- Angular: Framework para el desarrollo del frontend de la aplicación web.

Despliegue de Software

- GitHub Pages: Plataforma usada para desplegar la Landing Page directamente desde su repositorio.
  -----
  ### <a name="_h73kxbr9mxfe"></a>**5.1.2 Source Code Management** 
El código fuente es gestionado mediante Git y hospedado en GitHub. La organización del equipo contiene cuatro ramas:
...
- Backend
  ...
  que estarán dentro de cada uno de estos 3 repositorios: 

- Organizacion del  Proyecto TP1: https://github.com/parionalucasjosemanuel/upc-pre-2510-daos-4346-grupo5-tp1
- Organziacion del Proyecto TF1: https://github.com/parionalucasjosemanuel/upc-pre-2510-daos-4346-grupo5-tf1
- Organizacion del Proyecto: DD1:  https://github.com/parionalucasjosemanuel/upc-pre-2510-daos-4346-grupo5-dd1

Se sigue el flujo de trabajo Gitflow con las siguientes ramas principales:

- main: Contiene las versiones estables de entrega.
- develop: Rama de integración donde se agregan nuevas funcionalidades.
- feature/\*: Ramas temporales usadas para desarrollar funcionalidades específicas o capítulos del informe. Se nombran como feature/chapter#.

Versionado Semántico 2.0.0 (<https://semver.org/>)

- MAJOR: Cambios incompatibles en la API.
- MINOR: Nuevas funcionalidades compatibles.
- PATCH: Correcciones de errores menores.

Commits Convencionales (<https://www.conventionalcommits.org/>)

Formato: <type>[optional scope]: <description>
Ejemplos de tipo: feat, fix, docs, refactor, test, build, etc.

-----
### <a name="_gwd3n5toiotr"></a>**5.1.3 Source Code Style Guide & Conventions**
HTML

- Uso de minúsculas en nombres de elementos y atributos.
- Comillas obligatorias para los valores.
- Atributos alt, width, height en imágenes.
- Indentación de cuatro espacios.
- Sintaxis de HTML5.
- Evitar id innecesarios; preferir class y data-\*.

CSS

- Nombres de clases significativos.
- Palabras separadas por guiones.
- Usar notación hexadecimal corta cuando sea posible.
- Evitar !important; priorizar la especificidad.
- Uso de punto y coma final y espacio tras el :.
...
- Uso de anotaciones como @Autowired, @GetMapping, etc.
- Uso de Lombok para reducir boilerplate.
  -----
  ### <a name="_1ag0e6c5z7aa"></a>**5.1.4 Software Deployment Configuration**
La Landing Page del proyecto se despliega mediante GitHub Pages. El procedimiento seguido es:

1. Crear el repositorio landing-page.
1. Subir los archivos del proyecto con su respectivo commit.
1. Configurar la opción de GitHub Pages en el repositorio.
1. Copiar y usar la URL proporcionada por GitHub para visualizar la landing.
...
|Date |2025/24/4|
|Time|03:00 PM|
|Location|Modalidad virtual por Discord |
|Prepared By|Integrantes de TrabajandoYa|
|Attendess (to planning meeting) |<p>-Marllely Anahi Arias Segil,</p><p></p><p>-Jose Manuel Pariona Lucas,</p><p></p><p>-Jesús Fernando Paucar Zenteno,</p><p></p><p>-Stephano Renan Valdivia Quispe,</p><p></p><p>-Alessandro Netto Zevallos Linares</p><p></p>|
|Sprint n-1 Review Summary |<p>Se definieron las historias de usuario para  la landing  page y para la aplicación web de TuChambaMásCerca </p><p>La Landing Page se implementó exitosamente.</p>|
|<p>Sprint n-1 Retrospective</p><p>Sumary </p>|Hubo una buena  comunicación entre los integrantes y cada uno de ellos aportó con ideas para el proyecto (Landing Page- Aplicacion Web) |
|Sprint Goal & User Stories ||
|Sprint 1 Goal |En este  sprint se tiene como objetivo el desarrollo de  la Landing Page y su despliegue. Permitirá a los usuarios tener más seguridad al entrar  en  la  aplicación web  TuChambaMásCerca. Esto será confirmado cuando los usuarios ingresen a  la  aplicación web desde los call to action de  la Landing Page. |
|Sprint 1 Velocity |2|
|Sum of Story Points |2|

**5.2.1.2. Aspect Leaders and Collaborators.**

|**Team Member (Last  Name, First Name)** |**Github Username** |**Aspect Name 1 Leader (L) / Collaborator (C)**|
| :- | :- | :- |
|Jose Manuel Pariona Lucas|**micchonofficial** |**L**|
|Marllely Anahi Arias Segil|**kuwuk0**|**C**|
|Jesús Fernando Paucar Zenteno|**devFernando22**|**C**|
|Stephano Renan Valdivia Quispe|**steph\_ano**|**C**|
|Alessandro Netto Zevallos Linares|<p></p><p>**OutBreakAZL**</p>|**C**|
...
|**US-22**|**Navegación informativa en la Landing Page**|**W22**|**Informative navigation on the Landing Page**|**Como visitante, deseo recorrer la landing page para conocer la plataforma.**|**2**|<p>-Marllely Anahi Arias Segil,</p><p></p><p>-Jose Manuel Pariona Lucas,</p><p></p><p>-Jesús Fernando Paucar Zenteno,</p><p></p><p>-Stephano Renan Valdivia Quispe,</p><p></p><p>-Alessandro Netto Zevallos Linares</p>|**Done**|
|**US-23**|**Redirección a formulario de registro**|**W23**|**Redirect to registration form**|**Como visitante, deseo ser redirigido desde la landing page al formulario de registro.**|**2**|<p>-Marllely Anahi Arias Segil,</p><p></p><p>-Jose Manuel Pariona Lucas,</p><p></p><p>-Jesús Fernando Paucar Zenteno,</p><p></p><p>-Stephano Renan Valdivia Quispe,</p><p></p><p>-Alessandro Netto Zevallos Linares</p>|**Done**|
...
| :- | :- | :- | :- | :- | :- |
|**upc-pre-2510-daos-4346-grupo5-tp1**|**LandingPage**|<p>**41a046c**</p><p></p><p></p>|**feature:**|**feat: add login.html**|**22/04/2025**|
|**upc-pre-2510-daos-4346-grupo5-tp1**|**LandingPage**|**558bf60**|**feature:** |**feat: add script.js** |**22/04/2025**|
|**upc-pre-2510-daos-4346-grupo5-tp1**|**LandingPage**|<p>**ac81dce**</p><p></p>|**feature:** |**feat: add style.css**|**22/04/2025**|
|**upc-pre-2510-daos-4346-grupo5-tp1**|**LandingPage**|<p></p><p>**80741b3**</p><p></p><p></p>|**feature:** |**feat: Update index.html**|**22/04/2025**|
|**upc-pre-2510-daos-4346-grupo5-tp1**|**LandingPage**|<p></p><p>**98e5e84**</p><p></p>|**feature:** |**feat: Add files via upload**|**22/04/2025**|

**5.2.1.5. Execution Evidence for Sprint Review.**

Por este primer sprint, se muestran las capturas de la landing page y video que ilustra y explica la visualización y navegación logrados en este Sprint. 

![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.055.png)

![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.056.png)

![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.057.png)

![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.058.png)

![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.059.png)

![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.060.png)

![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.061.png)

**Link de Video de la Landing Page: <https://youtu.be/53ijzxZvLJY>** 

**5.2.1.6. Services Documentation Evidence for Sprint Review.**

**Link de la Landing Page desplegada:   [https://tuchambamascercainicio.netlify.app](https://tuchambamascercainicio.netlify.app/)** 
...
![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.062.png)![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.063.png)![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.064.png)

![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.065.png)

Para el despliegue de la landing page, se uso  lo siguiente: 

Netlify: Será utilizado para desplegar la landing page desarrollada, de manera que pueda accederse desde cualquier navegador mediante un enlace web.

![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.066.png)

**5.2.1.8. Team Collaboration Insights during Sprint.**

Aquí se encuentra la captura de las contribuciones de la landing page:

![](Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.067.png)

**Avance de Conclusiones, Bibliografía y Anexos.**

**Conclusiones y recomendaciones :**

1) **Empoderamiento del usuario como agente de cambio en la transparencia laboral**

El proyecto TuChambaMásCerca demuestra que una plataforma colaborativa puede empoderar a los profesionales del sector tecnológico, dándoles voz sobre sus experiencias laborales y transformándolos en agentes de cambio dentro del ecosistema laboral peruano. A través de funcionalidades como el mapa interactivo, la calificación anónima de empresas y el ranking colaborativo, se facilita la toma de decisiones informadas que podrían prevenir ambientes laborales tóxicos y fomentar buenas prácticas organizacionales. Este enfoque no solo responde a una necesidad actual no satisfecha por plataformas existentes como LinkedIn o GetOnBoard, sino que además propone un modelo más inclusivo, justo y centrado en la comunidad.

1) **Valor diferencial y sostenibilidad del modelo freemium**

El diseño de un modelo freemium accesible e inclusivo —con versiones gratuitas y premium— permite democratizar el acceso a información clave sin comprometer la sostenibilidad económica del proyecto. Este enfoque estratégico facilita la escalabilidad del producto al permitir monetización progresiva sin cerrar el acceso a los usuarios que más necesitan orientación. Además, las licencias institucionales para universidades fortalecen la vinculación academia-industria y promueven la empleabilidad desde el ámbito educativo.

1) **Innovación en experiencia de usuario basada en el contexto local**

El valor diferencial de TuChambaMásCerca radica en su enfoque local y segmentado, lo cual permite visibilizar patrones geográficos sobre condiciones laborales en Perú. A diferencia de plataformas globales, esta solución ha sido diseñada en base a entrevistas y técnicas de investigación contextual que revelan las preocupaciones reales de estudiantes y profesionales peruanos. El uso de elementos como el chatbot de apoyo emocional, filtros por modalidad de trabajo o métricas de clima organizacional refleja una comprensión profunda de las necesidades del usuario local, generando una experiencia altamente empática y funcional.

1) **Madurez metodológica del desarrollo del proyecto**

El desarrollo de TuChambaMásCerca evidencia una aplicación coherente y articulada de metodologías ágiles, diseño centrado en el usuario (Lean UX), modelado de requisitos (User Stories, Impact Mapping, Backlog), así como principios de diseño accesible e inclusivo. El uso de herramientas como Figma, Pivotal Tracker, GitHub y UXPressia permitió una ejecución profesional de cada fase del proyecto, desde el levantamiento de necesidades hasta la validación del prototipo. Este enfoque integral sienta las bases para una implementación técnica robusta, con miras a una futura expansión del producto.

1) **Cumplimiento integral de los entregables establecidos en la TB1**

El desarrollo del proyecto *TuChambaMásCerca* evidencia un cumplimiento riguroso y completo de todos los componentes exigidos por la estructura del Trabajo Final TB1 del curso *Desarrollo de Aplicaciones Open Source*. Desde la caracterización de la startup y la definición de la problemática, pasando por el levantamiento y especificación de requisitos, el diseño de producto, la arquitectura del software, hasta la configuración del entorno de desarrollo y la planificación de sprints, cada sección fue desarrollada en coherencia con los objetivos del curso. Asimismo, se lograron implementar las funcionalidades fundamentales establecidas en el backlog, y se dejaron sentadas las bases para los despliegues posteriores. Esto demuestra no solo la solidez técnica del equipo, sino también su capacidad para gestionar un proyecto real de desarrollo ágil de software, orientado al usuario y con valor social.

**Recomendaciones:** 

1. **Ejecutar una gestión ágil disciplinada basada en sprints temáticos enfocados**

Para asegurar el desarrollo ordenado y completo de todas las funcionalidades planteadas en el documento, es imprescindible estructurar los sprints del proyecto en función de bloques temáticos definidos por el backlog (registro de usuarios, recomendaciones, ranking, chatbot, etc.). Cada sprint debe contar con una planificación detallada, asignación clara de tareas y revisión colaborativa que permita detectar desviaciones y ajustar el ritmo de avance sin comprometer los entregables. Esta disciplina permitirá no solo cumplir con los objetivos funcionales propuestos, sino también mantener una cultura de mejora continua que se alinee con los principios de Lean UX y Scrum.

2. **Fortalecer la calidad del producto mediante validaciones continuas y pruebas con usuarios reales**

Tal como se propone en la fase de validación, es clave que cada funcionalidad desarrollada pase por ciclos de retroalimentación temprana y evaluación heurística. Esto no solo incluye pruebas técnicas (unitarias e integradas), sino también sesiones periódicas de usabilidad con perfiles similares a los segmentos objetivo (profesionales tech y estudiantes en búsqueda de prácticas). Las entrevistas, mapas de empatía y user journey previamente elaborados deben servir como base para diseñar pruebas de validación alineadas con las necesidades reales. Así se garantizará que el producto cumpla su promesa de utilidad, accesibilidad y confiabilidad desde el primer contacto del usuario.

3. **Desplegar progresivamente el sistema con documentación, control de versiones y ambientes diferenciados**

Para lograr un despliegue estable, ordenado y funcional de *TuChambaMásCerca*, se recomienda implementar una estrategia progresiva de desarrollo basada en lo establecido en los sprints planificados del informe, específicamente desde 5.2.1 hasta 5.2.4. Cada uno de estos sprints debe incluir su Sprint Planning, asignación de roles (Aspect Leaders y Collaborators), Sprint Backlog, evidencias de desarrollo, ejecución y documentación de servicios, así como análisis de colaboración en equipo. Además, estos entregables deben implementarse en ambientes diferenciados (desarrollo, pruebas y producción) para evitar interrupciones a usuarios finales. GitHub y GitFlow, ya definidos como herramientas centrales, deben utilizarse rigurosamente para versionar y documentar el progreso. Así, no solo se garantizará la calidad técnica del producto, sino también la trazabilidad y coordinación entre los miembros del equipo a lo largo del proceso de implementación.

4. **Cumplir estrictamente los principios de accesibilidad, seguridad y privacidad definidos en el alcance**


Una de las fortalezas del proyecto es su compromiso con la inclusión, la protección de datos y la navegación segura. Para lograr estos objetivos, es indispensable implementar desde el inicio estándares de seguridad como HTTPS, cifrado de contraseñas (bcrypt) y control de accesos. Asimismo, el desarrollo frontend debe aplicar principios de accesibilidad, asegurando compatibilidad con lectores de pantalla, navegación por teclado y una experiencia adaptada a distintos perfiles de usuario. El sistema de cambio de idioma (HU18) y las medidas de protección de datos personales (HU20 y HU21) no deben considerarse tareas secundarias, sino componentes estructurales que reflejan la ética del producto y su propuesta de valor.

**Bibliografia:**

1\. Pivotal Tracker. (s.f.). *Agile project management tool*. Recuperado el 24 de abril de 2025, de[ ](https://www.pivotaltracker.com/)<https://www.pivotaltracker.com/>

2\. GitHub. (s.f.). *Where the world builds software*. Recuperado el 24 de abril de 2025, de[ ](https://github.com/)<https://github.com/>

3\. UXPressia. (s.f.). *User journey mapping and persona builder tools*. Recuperado el 24 de abril de 2025, de[ ](https://uxpressia.com/)<https://uxpressia.com/>

4\. Figma. (s.f.). *The collaborative interface design tool*. Recuperado el 24 de abril de 2025, de[ ](https://www.figma.com/es-es/)<https://www.figma.com/es-es/>

5\. Ministerio de Trabajo y Promoción del Empleo del Perú. (2023). *Informe de empleabilidad y rotación laboral en el sector tecnológico peruano*. Recuperado el 24 de abril de 2025, de[ ](https://www.gob.pe/mtpe)<https://www.gob.pe/mtpe>

6\. Semantic Versioning. (s.f.). *Semantic Versioning 2.0.0*. Recuperado el 24 de abril de 2025, de[ ](https://semver.org/)<https://semver.org/>

7\. Ministerio de Trabajo y Promoción del Empleo del Perú. (2022). *Política Nacional de Empleo*. Recuperado el 24 de abril de 2025, de <https://www.gob.pe/mtpe/politicas-nacionales-empleo>

8\. Observatorio de Empleo y Dinámica Empresarial del Ministerio de Trabajo y Promoción del Empleo del Perú. (2024). *Análisis de tendencias del empleo en el sector tecnológico en el Perú*. Recuperado el 24 de abril de 2025, de <https://www.gob.pe/mtpe/observatorio-empleo>

9\. Gobierno de Perú. (2023). *Estrategia Nacional de Digitalización y Transformación Digital 2023-2025*. Recuperado el 24 de abril de 2025, de <https://www.gob.pe/estrategia-digitalizacion-peru>

10\. Ministerio de Economía y Finanzas del Perú. (2023). *Informe sobre la competitividad y el desarrollo tecnológico en el Perú*. Recuperado el 24 de abril de 2025, de <https://www.mef.gob.pe>



**Anexos:** 

**Video de Exposicion (TB1):** 
...
[ref1]: Aspose.Words.c6e287c5-2f09-4cf1-acce-a4f0252ffcb7.049.png
